...
const {fundWallet,fundStatus,userTransactions,getUserWalletBallance,verifyBankAccount,vendorTransactions} = require("../controllers/walletControllers")
...
router.get("/transactions/get/vendor",checkVendor,vendorTransactions)
