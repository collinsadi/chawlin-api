...
const {newUser,verifyEmail,loginUser,forgotPassword,resetPassword,getUser,verifyTwoFactor} = require("../controllers/userControllers")
...
router.post("/users/login/twofactor",verifyTwoFactor)
